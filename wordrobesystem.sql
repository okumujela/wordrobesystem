...
INSERT INTO `clothing_items` (`id`, `name`, `category_id`) VALUES
(1, 'Floral Blouse', 2),
(2, 'Sneakers', 5);
...
(1, 'okumucs100@gmail.com', '1234'),
(3, 'johndoe@mail.com', '1234');
...
--
ALTER TABLE `clothing_items`
  ADD CONSTRAINT `clothing_items_ibfk_1` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`);
COMMIT;
